...
def _evaluate_with_llm(
    ...
    """
    llm = LLM(model=settings.bedrock_model_input_supervisor, max_retries=1)
...
{{
  ...
  "rationale": "<two to three sentences explaining your decision>"
    ...
    kickoff_crew(crew, "input_supervisor", supervisor_input.run_id, [settings.bedrock_model_input_supervisor])
